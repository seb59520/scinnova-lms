-- Script pour réactiver RLS avec des politiques SIMPLES sans fonction helper
-- Alternative à fix-rls-access-issue.sql si la fonction is_admin() pose problème
...
-- ============================================================================
-- ÉTAPE 4 : Créer des politiques ULTRA SIMPLES (sans fonction, sans sous-requêtes complexes)
-- ============================================================================
...
-- Version SIMPLIFIÉE avec sous-requête directe (sans fonction)
...
-- ============================================================================
SELECT 
  'RLS réactivé avec politiques simples' as status,
