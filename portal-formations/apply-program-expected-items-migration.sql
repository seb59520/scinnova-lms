-- =====================================================
-- Script pour appliquer la migration program_expected_items
...
DROP POLICY IF EXISTS "admin_trainer_full_access_program_expected_items" ON program_expected_items;
...
DROP POLICY IF EXISTS "users_read_published_program_expected_items" ON program_expected_items;
